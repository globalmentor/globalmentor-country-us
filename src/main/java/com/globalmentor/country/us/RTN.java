 ...
 * <p>
 * A RTN is is a nine-digit number.
 * </p>
 * <p>
...
public class RTN {
	...
	public enum Category {
		...
		/**
		 * Returns the base ID of this category. Some categories may not have more than one category ID besides the base.
	...
	/**
	 * @return The federal reserve district of the institution identified by the RTN, or <code>null</code> if this RTN is not associated with a federal reserve
	 *         district.
	 */
	...
	/**
	 * Determines if this object is equivalent to another object. This method considers another object equivalent if it is another RTN with the same value.
